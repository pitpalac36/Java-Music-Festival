...
public class TicketDbRepository implements ITicketRepository {
    ...
    public TicketDbRepository(Properties properties) {
        logger.info("Initializing repository.TicketDbRepository with properties : {}", properties);
    ...
    public void save(Ticket ticket) {
        ...
        try (PreparedStatement statement = connection.prepareStatement("INSERT INTO tickets (showId, purchaserName, number) VALUES (?, ?, ?)")) {
